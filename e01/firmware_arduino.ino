...
/*
 * Função para poder acender LED acima de temperatura específica
 */

void conditional_led(int read_zero)
{
  /*
   * 430 aproximadamente 2.2 Volts = 32ºC
   */
  if (read_zero >= 430){
